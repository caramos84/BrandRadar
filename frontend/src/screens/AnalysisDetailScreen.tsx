              ...
              <div className="drawer-analysis-panel">
                {activeDrawerPanel === 'radar' && (
                  <>
                    ...
                    <p className="asset-meta-secondary">Visual Load score: {effectiveVisualLoad == null ? 'MVP estimate pending' : formatScore(effectiveVisualLoad)}</p>
                    ...
                    <p className="asset-meta-secondary">Cluster label: {selectedAsset?.analysis_cluster_label || 'Unclassified'}</p>
                  </>
                )}
